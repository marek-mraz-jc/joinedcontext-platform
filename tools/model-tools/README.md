...
| `src/gen_qb.py` | `model.qb.ttl`, the RDF Data Cube structure of a model that declares a Data Structure Definition (`qb_dsd`, `qb_component`) | DM-60 |
...
python3 src/gen_qb.py model.linkml.yaml -o model.qb.ttl
